    ...
    <div style={{ padding: 28 }}>
      ...
      {!msgOpen ? (
        ...
        <div style={{ marginTop: 22 }}>
          <div style={{
            fontSize: 11, color: "#00e099", fontWeight: 700,
            marginBottom: 8, letterSpacing: "0.08em",
          }}>🔒 ENCRYPTED ANONYMOUS MESSAGE</div>
...
return (
<div style={{
background: “#0a0a16”, border: “1px solid #1e1e2e”,
...
<text x={pos.cx} y={pos.cy - r - 8} textAnchor=“middle”
fill={color} fontSize={9} fontWeight={700} opacity={0.9}>
{zone.area}
</text>
    ...
    {tab === "demand" && (
      <div style={{ padding: "24px 0 40px" }}>
        <div style={{
          ...
          🔥 <strong style={{ color: "#ff9999" }}>Demand signals</strong> show how many people are actively searching in each area. Use this to gauge competition before you apply — or list your place where demand is highest.
        </div>
        <DemandMap />
        <div style={{
